        ...
        <div className="px-6 py-2 space-y-4 flex-1 overflow-hidden flex flex-col">
          {category?.has_parts && category.parts && (
            <div className="flex flex-wrap gap-2">
              <span className="text-xs font-medium text-slate-500 mr-1 self-center">Sub-categories:</span>
              ...
              <div className="p-4 space-y-3">
                {isLoading ? (
                  ...
                  <div className="text-center py-12">
                    <p className="text-sm text-slate-500">No schemes found in this category.</p>
                  </div>
                )}
              </div>
            </ScrollArea>
